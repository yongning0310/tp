export declare class HighlightRuleComponent {
    ...
    isSlice: boolean;
    bounds: number[][];
    constructor(lineNumber: number, isSlice?: boolean, bounds?: number[][]);
     ...
     */
    static computeCharBounds(bound: number[], line: string): number[];
    /**
     ...
     * @returns {[number, number]} The actual bound computed
     */
    static computeWordBounds(bound: number[], line: string): number[];
    /**
     ...
     */
    static computeLinePartBounds(linePart: string, line: string): number[][];
}
