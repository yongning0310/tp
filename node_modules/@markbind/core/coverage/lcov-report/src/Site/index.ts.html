    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>215/719</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">23.31% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>45/193</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">22.29% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>33/148</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>209/686</span>
            </div>
...
<a name='L1736'></a><a href='#L1736'>1736</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
    ...
    this.postBackgroundBuildFunc = postBackgroundBuildFunc || (<span class="fstat-no" title="function not covered" >() =</span>&gt; {});
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw (new Error(`Failed to read the site config file '${this.siteConfigPath}' at`</span>
...
<span class="cstat-no" title="statement not covered" >    Site.printBaseUrlMessage();</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    this.addressablePages</span>
      .filter(<span class="fstat-no" title="function not covered" >addressablePage </span>=&gt; <span class="cstat-no" title="statement not covered" >!addressablePage.src.startsWith('_'))</span>
      .forEach(<span class="fstat-no" title="function not covered" >(p</span>age) =&gt; {
        const addressablePagePath = <span class="cstat-no" title="statement not covered" >path.join(this.rootPath, page.src);</span>
        ...
        const pageName = <span class="cstat-no" title="statement not covered" >_.startCase(fsUtil.removeExtension(path.basename(addressablePagePath)));</span>
...
<span class="cstat-no" title="statement not covered" >    await Site.writeToSiteConfig(config, configPath);</span>
  }
&nbsp;
  /**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await this.layoutManager.updateLayouts(filePaths);</span>
...
&nbsp;
  ...
  async <span class="fstat-no" title="function not covered" >rebuildPagesBeingViewed(</span>_currentPageViewed: string) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Method not implemented.');</span>
  }
&nbsp;
  // eslint-disable-next-line @typescript-eslint/no-unused-vars, class-methods-use-this
  async <span class="fstat-no" title="function not covered" >removeAsset(</span>_removedPageFilePaths: string | string[]) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Method not implemented.');</span>
  }
&nbsp;
  // eslint-disable-next-line @typescript-eslint/no-unused-vars, class-methods-use-this
  async <span class="fstat-no" title="function not covered" >backgroundBuildNotViewedFiles(</span>_arg0?: any, _arg1?: any) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Method not implemented.');</span>
  }
}
&nbsp;
