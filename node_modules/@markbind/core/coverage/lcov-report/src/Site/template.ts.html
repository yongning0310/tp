...
<span class="cstat-no" title="statement not covered" >      fs.access(this.root)</span>
        .catch(<span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >fs.mkdirSync(this.root))</span>
        .then(<span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >fsUtil.copySyncWithOptions(this.template, this.root, { overwrite: false }))</span>
        .then(resolve)
        .catch(reject);
    });
  }
