...
<a name='L192'></a><a href='#L192'>192</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">8x</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_.has(node.attribs, 'content') &amp;&amp; _.has(node.attribs, 'src')) {
<span class="cstat-no" title="statement not covered" >      logger.warn(`${node.name} has a 'content' attribute, 'src' attribute has no effect.`);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  processScrollTopButtonAttributes(</span>node: MbNode) {
<span class="cstat-no" title="statement not covered" >    this.processAttributeWithoutOverride(node, 'icon', true);</span>
  }
}
&nbsp;</pre></td></tr></table></pre>
