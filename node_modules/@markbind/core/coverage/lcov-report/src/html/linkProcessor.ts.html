...
<a name='L261'></a><a href='#L261'>261</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">10x</span>
...
function _convertRelativeLink(node: MbNode, cwf: string, rootPath: string,
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!resourcePath || !isIntraLink(resourcePath)) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isExtMd) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (resourcePathUrl.hash) {
    // remove hash portion (if any) in the resourcePath
<span class="cstat-no" title="statement not covered" >    resourcePath = resourcePathUrl.pathname; </span>// eslint-disable-line no-param-reassign
  }
&nbsp;
