...
<a name='L73'></a><a href='#L73'>73</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">7x</span>
...
<span class="cstat-no" title="statement not covered" >      resourcePaths.forEach(<span class="fstat-no" title="function not covered" >resourcePath </span>=&gt; <span class="cstat-no" title="statement not covered" >linkProcessor.validateIntraLink(resourcePath, cwf, this.config))</span>;</span>
    });
&nbsp;
